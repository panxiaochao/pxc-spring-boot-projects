...
- **接口描述**：批量获取校区列表
- **请求方法**：GET
- **完整请求路径**：`https://jyjzhfw.qiantang.gov.cn/tyba/open-api/school/campus/list`
...
var config = {
  method: 'get',
  url: 'https://jyjzhfw.qiantang.gov.cn/tyba/open-api/school/campus/list?accessToken=AT-10-R6Bl-dFf8itd6BM-pdSMzKRTR-kTmlpO&schoolId=11',
  headers: {
    'X-App-Id': '1'
  }
};
