...
- **接口描述**：根据校区ID获取校区详情
- **请求方法**：GET
- **完整请求路径**：`https://jyjzhfw.qiantang.gov.cn/tyba/open-api/school/campus/info`
...
var config = {
  method: 'get',
  url: 'https://jyjzhfw.qiantang.gov.cn/tyba/open-api/school/campus/info?accessToken=AT-10-R6Bl-dFf8itd6BM-pdSMzKRTR-kTmlpO&campusId=111',
  headers: {
    'X-App-Id': '1'
  }
};
