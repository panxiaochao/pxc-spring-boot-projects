...
- **接口描述**：批量获取单位列表
- **请求方法**：GET
- **完整请求路径**：`https://jyjzhfw.qiantang.gov.cn/tyba/open-api/unit/list`
...
var config = {
  method: 'get',
  url: 'https://jyjzhfw.qiantang.gov.cn/tyba/open-api/unit/list?accessToken=AT-10-R6Bl-dFf8itd6BM-pdSMzKRTR-kTmlpO&lastSequence=0&limit=100',
  headers: {
    'X-App-Id': '1'
  }
};
