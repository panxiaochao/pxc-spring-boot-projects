...
- **接口描述**：根据单位ID获取单位详情
- **请求方法**：GET
- **完整请求路径**：`https://jyjzhfw.qiantang.gov.cn/tyba/open-api/unit/info`
...
var config = {
  method: 'get',
  url: 'https://jyjzhfw.qiantang.gov.cn/tyba/open-api/unit/info?accessToken=AT-10-R6Bl-dFf8itd6BM-pdSMzKRTR-kTmlpO&unitId=123',
  headers: {
    'X-App-Id': '1'
  }
};
